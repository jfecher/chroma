...
func anteRules() Rules {
	return Rules{
		"root": {
			...
			{`\b(if|else|import|with|in|do|extern|try|given|can|effect|handler|handle|continue|return|fn|mut|opaque|impl|match|trait|module|recur|type|and|loop|do|then|not|or)(?!\')\b`, Keyword, nil},
			{`\b(i8|i16|i32|i64|isz|u8|u16|u32|u64|usz|f16|f32|f64|string|char|unit|bool|ref)(?!\')\b`, KeywordType, nil},
